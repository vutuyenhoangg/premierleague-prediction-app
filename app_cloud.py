...
def build_ai_match_suggestion_prompt(match_row: dict) -> str:
    ...
    prompt = (
        ...
        "- Chỉ trả về đúng 2 phần: một đoạn phân tích và một dòng dự đoán ngay bên dưới.\n"
        "- Tổng toàn bộ câu trả lời không được vượt quá 120 từ tiếng Việt, tính theo các "
        "cụm ký tự được ngăn cách bằng dấu cách.\n"
        "- Đoạn phân tích không được vượt quá 100 từ.\n"
        "- Dòng dự đoán không được vượt quá 20 từ và phải bắt đầu chính xác bằng 'Dự đoán:'.\n"
        "- Đoạn phân tích chỉ được gồm tối đa 3 câu.\n"
        "- Không trình bày toàn bộ dữ liệu đã tìm thấy. Chỉ chọn những thông tin có ảnh hưởng "
        "lớn nhất đến dự đoán cuối cùng.\n"
        "- Bắt buộc nêu phong độ hoặc lực lượng hiện tại và sự khác biệt chuyên môn quan trọng "
        "nhất giữa hai đội.\n"
        "- Bắt buộc nêu đối đầu lịch sử và đối đầu gần đây trong cùng một câu súc tích. "
        "Ví dụ: 'Anh thắng 6/14 lần gặp nhau; trong 5 trận gần nhất, Anh thắng 2, "
        "Argentina thắng 1 và hòa 2'.\n"
        "- Không kể chi tiết từng trận đối đầu, từng cầu thủ, từng thống kê hoặc từng nguồn.\n"
        "- Chỉ đề cập tối đa 2 cầu thủ nếu phong độ hoặc tình trạng của họ ảnh hưởng trực tiếp "
        "đến dự đoán.\n"
        "- Không giải thích các số liệu xác suất vô địch, Elo, xếp hạng hoặc tỷ lệ cược nếu "
        "chúng không làm thay đổi rõ rệt kết luận.\n"
        "- Phải liên kết dữ liệu với dự đoán bằng một lập luận rõ ràng, nhưng không lặp lại "
        "cùng một ý dưới nhiều cách diễn đạt.\n"
        "- Với trận knock-out, có thể dự đoán kết quả trong 90 phút, hiệp phụ hoặc luân lưu "
        "dựa trên kịch bản có khả năng cao nhất.\n"
        "- Sau đoạn phân tích, xuống dòng đúng một lần và viết dòng dự đoán riêng.\n"
        "- Không có dòng trống giữa phần phân tích và dòng dự đoán.\n"
        "- Không dùng tiêu đề, danh sách, Markdown, HTML, CSS, code block hoặc phần nguồn.\n"
        "- Trước khi trả lời, hãy tự đếm số từ. Nếu vượt quá 120 từ, bắt buộc rút gọn rồi "
        "mới xuất kết quả.\n"
        "- Chỉ trả về câu trả lời cuối cùng, tuyệt đối không trình bày quá trình tìm kiếm "
        "hoặc kiểm tra số từ."
    )
