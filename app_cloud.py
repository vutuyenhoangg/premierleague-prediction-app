...
def build_ai_match_suggestion_prompt(match_row: dict) -> str:
    ...
    prompt = (
        ...
        "Hãy phân tích trận đấu dưới đây và đưa ra nhận định khách quan về cục diện, "
        "đội có lợi thế hơn và kịch bản kết quả có khả năng xảy ra nhất.\n\n"
    
        "Trước khi trả lời, bắt buộc tìm kiếm và đối chiếu thông tin từ nhiều nguồn "
        "đáng tin cậy. Ưu tiên FIFA, liên đoàn bóng đá, thông báo chính thức của đội tuyển, "
        "hãng tin thể thao uy tín và các nền tảng thống kê chuyên nghiệp. "
        "Không được tự tạo dữ liệu, chấn thương, đội hình, thống kê hoặc thông tin chưa được xác nhận.\n\n"
    
        "Khi phân tích, hãy cân nhắc các yếu tố quan trọng sau:\n"
        "- Phong độ trong 5 đến 10 trận gần nhất, ưu tiên trận chính thức và các đối thủ "
        "có trình độ tương đương.\n"
        "- Khả năng ghi bàn, phòng ngự, tạo cơ hội, hiệu quả dứt điểm, kiểm soát thế trận "
        "và chỉ số xG nếu có nguồn đáng tin cậy.\n"
        "- Tình hình lực lượng mới nhất, gồm chấn thương, treo giò, thể trạng, đội hình dự kiến "
        "và phong độ của các cầu thủ chủ chốt.\n"
        "- Tương quan chất lượng và chiều sâu đội hình, kinh nghiệm quốc tế, khả năng xoay vòng "
        "và mức độ phụ thuộc vào cá nhân.\n"
        "- Sự tương khắc chiến thuật, gồm pressing, phản công, kiểm soát bóng, chuyển trạng thái, "
        "phòng ngự bóng bổng và tình huống cố định.\n"
        "- Thành tích đối đầu trực tiếp, nhưng giảm trọng số nếu các trận đã diễn ra quá lâu "
        "hoặc không còn phản ánh đúng thực lực hiện tại.\n"
        "- Bối cảnh trận đấu, mục tiêu thi đấu, vòng đấu, thời gian nghỉ, lịch di chuyển, "
        "sân đấu, thời tiết và lợi thế cổ động viên nếu có ảnh hưởng rõ ràng.\n"
        "- Có thể tham khảo xếp hạng FIFA, Elo, mô hình xác suất hoặc tỷ lệ cược thị trường "
        "để đối chiếu, nhưng không dùng làm căn cứ duy nhất.\n\n"
    
        "Đối với trận đấu loại trực tiếp, không mặc định trận đấu sẽ được quyết định trong 90 phút. "
        "Hãy đánh giá khả năng kết thúc trong thời gian thi đấu chính thức, phải bước vào hiệp phụ "
        "hoặc được quyết định bằng luân lưu. Cần cân nhắc thể lực, chiều sâu đội hình, kinh nghiệm "
        "knock-out, tâm lý thi đấu và năng lực của thủ môn. "
        "Nếu dự đoán trận đấu cần hiệp phụ hoặc luân lưu, hãy nêu rõ tỉ số sau 90 phút "
        "và đội có khả năng đi tiếp.\n\n"
    
        f"Hãy thực hiện cho trận đấu giữa {match_name} tại World Cup 2026.\n\n"
    
        "Thông tin từ app để xác định chính xác trận đấu và đối chiếu với kết quả tìm kiếm:\n"
        f"{app_context}\n\n"
    
        "Nếu kết quả tìm kiếm có nhiều trận trùng tên, chỉ sử dụng thông tin của trận đúng "
        "World Cup 2026, đúng vòng đấu, thời gian và bối cảnh được cung cấp ở trên. "
        ...
        "Yêu cầu đầu ra:\n"
        "- Viết hoàn toàn bằng tiếng Việt và chỉ gồm một đoạn văn bản thuần.\n"
        "- Không quá 90 từ.\n"
        "- Phân tích ngắn gọn phong độ, lực lượng hoặc chiến thuật; chỉ đề cập đối đầu "
        "nếu thực sự có giá trị tham khảo.\n"
        "- Nêu đội có lợi thế hơn hoặc đội có khả năng đi tiếp, nhưng không khẳng định tuyệt đối.\n"
        "- Kết thúc bằng một dự đoán cụ thể về tỉ số và kịch bản trận đấu. "
        "Ví dụ: 'Dự đoán: 2-1', 'Dự đoán: hòa 1-1 sau 90 phút, đội A thắng trong hiệp phụ' "
        ...
        "- Không thêm tiêu đề, nhãn 'AI gợi ý', phần 'Nguồn', lời dẫn hoặc mô tả quá trình tìm kiếm.\n"
        "- Chỉ trả về nội dung phân tích cuối cùng."
    )
