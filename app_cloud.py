...
def build_ai_match_suggestion_prompt(match_row: dict) -> str:
    ...
    prompt = (
        ...
        "Bắt buộc kiểm tra thành tích đối đầu trực tiếp giữa hai đội. Nếu đã từng gặp "
        "nhau, hãy nêu thống kê cụ thể, ưu tiên số trận gần nhất hoặc toàn bộ lịch sử "
        "đối đầu có dữ liệu đáng tin cậy, gồm số trận mỗi đội thắng, số trận hòa và có "
        "thể thêm tổng số bàn thắng nếu thực sự hữu ích. "
        "Ví dụ: 'Hai đội gặp nhau 6 lần, đội A thắng 3, đội B thắng 2 và hòa 1'. "
        "Không được chỉ nhận xét chung chung rằng một đội có thành tích đối đầu tốt hơn. "
        "Nếu chưa từng gặp nhau hoặc không tìm thấy dữ liệu đáng tin cậy, hãy nói ngắn "
        "gọn rằng hai đội chưa có đối đầu trực tiếp đáng kể. "
        "Giảm trọng số của các trận đối đầu đã diễn ra quá lâu hoặc khi lực lượng, "
        "huấn luyện viên và trình độ hiện tại đã thay đổi đáng kể.\n\n"
    
        "Đối với trận đấu loại trực tiếp, không mặc định trận đấu sẽ được quyết định "
        "trong 90 phút. Hãy đánh giá khả năng trận đấu kết thúc trong thời gian chính "
        "thức, phải bước vào hiệp phụ hoặc được quyết định bằng luân lưu. "
        "Cần cân nhắc thể lực, chiều sâu đội hình, chất lượng cầu thủ dự bị, kinh nghiệm "
        ...
        "Không được đưa ra dự đoán chỉ dựa trên một yếu tố đơn lẻ. "
        "Hãy tổng hợp phong độ, lực lượng, đối đầu, chiến thuật, thống kê hiệu suất và "
        "bối cảnh trận đấu. Phần giải thích phải chỉ rõ vì sao các yếu tố đó dẫn đến "
        "dự đoán cuối cùng. Khi các dữ liệu đưa ra tín hiệu trái chiều, hãy xác định "
        "yếu tố nào có trọng số lớn hơn trong bối cảnh hiện tại.\n\n"
        ...
        "Yêu cầu đầu ra:\n"
        "- Viết hoàn toàn bằng tiếng Việt, chỉ gồm một đoạn văn bản thuần.\n"
        "- Không quá 90 từ.\n"
        "- Bắt buộc nêu thống kê đối đầu trực tiếp cụ thể nếu có dữ liệu đáng tin cậy.\n"
        "- Kết hợp phong độ, lực lượng, chiến thuật, đối đầu và bối cảnh để giải thích "
        "ngắn gọn nhưng thuyết phục cho dự đoán.\n"
        "- Nêu đội có lợi thế hơn hoặc đội có khả năng đi tiếp, nhưng không khẳng định "
        "chắc chắn tuyệt đối.\n"
        "- Kết thúc bằng dự đoán tỉ số và kịch bản cụ thể, chẳng hạn "
        "'Dự đoán: 2-1', 'Dự đoán: hòa 1-1 sau 90 phút, đội A thắng trong hiệp phụ' "
